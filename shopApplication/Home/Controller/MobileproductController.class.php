...
class MobileproductController extends MyController{
    ...
    public function productList(){
        ...
        // 分页处理
        $page = new \Think\MyPagemobile($getPageCount, $getPageSize);

        $productRes = $modelProduct->field('id,cat_id,pro_name,pro_subname,market_price,promote_price,list_image,is_new,is_promote,description')
                                   ->where($where)
                                   ->order($order)
        ...
        $this->assign('counts',$getPageCount);
        $this -> display('mobileproductList');
    }
    ...
    public function promoteList(){
       //SEO
        ...
        $this->assign('counts',$getPageCount);
        $this->assign('productList', $productRes);
        $this -> display('mobilepromoteList');
    }
}
